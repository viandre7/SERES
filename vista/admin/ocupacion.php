...
<body >
    <div class="container border ">
        ...
        <div class="row bg-light  justify-content-center " >
            <form action="../../controlador/ocupacion.create.php" method="POST" >
                <div class="row justify-content-center text-center">
                    <h3 class=" text-center ">Ocupacion</h3>
                </div>
                <br>

                 <!-- Datos para ingresar valores del formulario -->
                 <div class="row justify-content-center">
                    <h5 class=" text-center ">Crear una Ocupacion</h5>
                </div>
                <br>
                <div class="row justify-content-center">
                ...
                <div class="modal fade" id="modalModificar" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <form action="../../controlador/ocupacion.update.php" method="POST" enctype="multipart/form-data">
                            <div class="row">
                            <div class="col-12">
    ...
    <script src="../../js/administrador/ocupacion.js"></script>
</html>