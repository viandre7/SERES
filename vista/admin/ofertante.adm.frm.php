...
<body >
        ...
        <div class="row   justify-content-center " >
            <form class="form-group" id="categoria">
                <div class="row justify-content-center text-center">
                    <h3 class=" text-center ">OFERTANTES</h3>
                </div>
                <br>
                 <!-- datos del js -->
                 <div class="row justify-content-center text-center">
                    <h5 class=" text-center ">Ofertantes Registrados</h5>
                </div>
                <div class="row my-1 ">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form class="form-group" id="ofertanteestado" >
                                    <div class="row">
                                        <div class="col-12 border-bottom">
                                            <input type="number" name="txtidofertael" id="txtidofertael" hidden>
                                            <h5>Esta seguro de cambiar el estado al Ofertante:</h5>
                                            <h4 class="form-control" id="txtNombreOfertante" readonly></h4>
                                            <h5>Estado Actual</h5>
    ...
    <script src="../../js/administrador/ofertantes.js"></script>
</html>