...
<body >
    <div class="container border ">
        ...
        <div class="row bg-light  justify-content-center " >
            <form action="../../controlador/education.create.php" method="POST" enctype="multipart/form-data">
                ...
                <br>
                 ...
                 <div class="row justify-content-center">
                    <h5 class=" text-center ">Crear un Nivel de Educacion</h5>
                </div>
                <br>
                <div class="row justify-content-center">
                    <div class="col-6 justify-content-center" >
                        <label> Nombre</label>
                        <input    class="form-control" type="text" name="txtEdu" id="txtEdu" >
                    </div>
                ...
                <div class="modal fade" id="modalModificar" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <form action="../../controlador/education.update.php" method="POST" enctype="multipart/form-data">
                            <div class="row">
                            <div class="col-12">
                      ...
                      <div class="modal-content">
                        ...
                        <div class="row">
                                    <div class="col-12 border-bottom">
                                        <input type="number" name="txtId" id="txtId"  hidden>
    ...
    <script src="../../js/administrador/education.js"></script>
</html>