function modificar (id_categoria, categoria){
    $("#txtIdCatMod").val(id_categoria);
    $("#txtCatMod").val(categoria);
}
...
function eliminar(id_categoria, categoria, estado){
    $("#txtIdCatElm").val(id_categoria);
    $("#catEliminar").html(categoria);
    if(estado=="A"){
...
$(document).ready(function(){
    ...
    function buscar (){
        $.ajax({
            url:'../../controlador/categoria.adm.read.php',
            type: 'POST',
            dataType: 'json',
            data : null,
        }).done(function(json){
            ...
            datos += '<caption>Lista de Categorias</caption>';   
                datos += '<thead class="table-light">';
                    datos += '<tr  class="table-light border-primary ">';
                        ...
                        datos += '<th class="text-center border border-primary align-middle">Imagen</th>';
                    ...
                    $.each(json, function(key, value){
                        datos += '<tr>';
                            if(value.estado=="A"){
                                ...
                                datos += '<td class=" border border-primary activo text-center align-middle" ><img src="../../componente/img/categorias/'+value.img_categoria+'" title="'+value.categoria+'" class="img-thumbnail img-fluid img_adm"></td>';
                                datos += '<td class=" border border-primary activo text-center align-middle" ><a class="btn btn-primary" onclick="modificar('+value.id_categoria+',\''+value.categoria+'\')"  data-bs-toggle="modal"  data-bs-target="#modalModificar"><i class="fas fa-edit"></i></a></td>';
                                datos += '<td class=" border border-primary activo text-center align-middle" ><a class="btn btn-secondary" onclick="eliminar('+value.id_categoria+',\''+value.categoria+'\',\''+value.estado+'\')" data-bs-toggle="modal"  data-bs-target="#modalEliminar"><i class="fas fa-exchange-alt"></i></a></td>';
                                ...
                                datos += '<td class=" border border-primary inactivo text-center align-middle" ><img src="../../componente/img/categorias/'+value.img_categoria+'" title="'+value.categoria+'" class="img-thumbnail img-fluid img_adm"></td>';
                                datos += '<td class=" border border-primary inactivo text-center align-middle" ><a class="btn btn-primary" onclick="modificar('+value.id_categoria+',\''+value.categoria+'\')"  data-bs-toggle="modal"  data-bs-target="#modalModificar"><i class="fas fa-edit"></i></a></td>';
                                datos += '<td class=" border border-primary inactivo text-center align-middle" ><a class="btn btn-btn-secondary" onclick="eliminar('+value.id_categoria+',\''+value.estado+'\',\''+value.categoria+'\')" data-bs-toggle="modal"  data-bs-target="#modalEliminar"><i class="fas fa-exchange-alt"></i></a></td>';
                ...
                buttons: [
                    {
                        ...
                        pageSize: 'LEGAL',
                        download: 'open',
                        title: 'SERES - Categorias',
                        titleAttr: 'PDF',
                        className: 'btn-primary',
                        messageTop: 'Categorias',
                        messageTop: 'PDF con la información de las categorias.',
                        footer: true,
                        autoFiltre : true ,
                    ...
                    },
                    {
                        ...
                        title: 'Categorias',
                        className: 'btn-primary',
                        messageTop: 'Impresión con la información de las categorias.',
                        titleAttr: 'IMPRIMIR',
                        exportOptions : {
                            stripHtml: false, /* Aquí indicamos que no se eliminen las imágenes */
                            columns: [0,1,2]
    ...
    $(document).on('click','#btnEliminar',function(event){
        event.preventDefault();
            $.ajax({
                url:'../../controlador/categoria.adm.delete.php',
                type: 'POST',
                dataType: 'json',
