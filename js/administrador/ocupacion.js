function modificar (id_ocupacion, ocupacion, codigo_dane){
    $("#id").val(id_ocupacion);
    $("#txtact").val(ocupacion);
    $("#txtcode").val(codigo_dane);
...
function eliminar(id_ocupacion, ocupacion, estado){
    $("#txtIdCatElm").val(id_ocupacion);
    $("#catEliminar").html(ocupacion);
    if(estado=="A"){
...
$(document).ready(function(){
    ...
    function buscar (){
        $.ajax({
            url:'../../controlador/ocupacion.read.php',
            type: 'POST',
            dataType: 'json',
            data : null,
        }).done(function(json){
            ...
            datos += "<table id='tableCat' class='table table-striped  compact table-hover row-border border-dark table-bordered dt-responsive nowrap'  style='font-size: 18px ' >";
                datos += '<thead>';
                    datos += '<tr>';
                        ...
                        datos += '<th class="text-center border border-primary align-middle">Ocupacion</th>';
                    ...
                    $.each(json, function(key, value){
                        datos += '<tr>';
                            if(value.estado=="A"){
                                ...
                                datos += '<td class="border border-primary activo text-wrap">'+value.ocupacion+'</td>'; 
                                datos += '<td class="border border-primary activo text-wrap">'+value.codigo_dane+'</td>'; 
                                datos += '<td class="border border-primary activo text-center align-middle" ><a class="btn btn-primary" onclick="modificar('+value.id_ocupacion+',\''+value.ocupacion+'\',\''+value.codigo_dane+'\',\''+value.estado+'\')"  data-bs-toggle="modal"  data-bs-target="#modalModificar"><i class="fas fa-edit"></i></a></td>';
                                datos += '<td class="border border-primary activo text-center align-middle" ><a class="btn btn-danger" onclick="eliminar('+value.id_ocupacion+',\''+value.ocupacion+'\',\''+value.estado+'\')" data-bs-toggle="modal"  data-bs-target="#modalEliminar"><i class="fas fa-exchange-alt"></i></a></td>';
                                ...
                                datos += '<td class="border border-primary inactivo text-wrap">'+value.codigo_dane+'</td>'; 
                                datos += '<td class="border border-primary inactivo text-center align-middle" ><a class="btn btn-primary" onclick="modificar('+value.id_ocupacion+',\''+value.ocupacion+'\',\''+value.codigo_dane+'\')"  data-bs-toggle="modal"  data-bs-target="#modalModificar"><i class="fas fa-edit"></i></a></td>';
    ...
    $(document).on('click','#btnEliminar',function(event){
        event.preventDefault();
            $.ajax({
                url:'../../controlador/ocupacion.delete.php',
                type: 'POST',
                dataType: 'json',
