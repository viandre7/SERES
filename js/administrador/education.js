function modificar (id_nivel_educativo, nivel_educativo){
    $("#id").val(id_nivel_educativo);
    $("#txtnom").val(nivel_educativo);
...
function eliminar(id_nivel_educativo, nivel_educativo, estado){
    $("#txtId").val(id_nivel_educativo);
    $("#catEliminar").html(nivel_educativo);
    if(estado=="A"){
...
$(document).ready(function(){
            ...
            datos += "<table id='tableCat' class='table table-striped  compact table-hover row-border border-dark table-bordered dt-responsive nowrap'  style='font-size: 18px ' >";
                datos += '<thead>';
                    datos += '<tr>';
                        ...
                        datos += '<th class="text-center border border-primary align-middle">Nivel Educativo</th>';
                    ...
                    $.each(json, function(key, value){
                        datos += '<tr>';
                            if(value.estado=="A"){
                                ...
                                datos += '<td class=" border border-primary activo text-center align-middle" ><a class="btn btn-primary" onclick="modificar('+value.id_nivel_educativo+',\''+value.nivel_educativo+'\')"  data-bs-toggle="modal"  data-bs-target="#modalModificar"><i class="fas fa-edit"></i></a></td>';
                                datos += '<td class=" border border-primary activo text-center align-middle" ><a class="btn btn-danger" onclick="eliminar('+value.id_nivel_educativo+',\''+value.nivel_educativo+'\',\''+value.estado+'\')" data-bs-toggle="modal"  data-bs-target="#modalEliminar"><i class="fas fa-exchange-alt"></i></a></td>';
                                ...
                                datos += '<td class=" border border-primary inactivo text-center align-middle" ><a class="btn btn-primary" onclick="modificar('+value.id_nivel_educativo+',\''+value.nivel_educativo+'\')"  data-bs-toggle="modal"  data-bs-target="#modalModificar"><i class="fas fa-edit"></i></a></td>';
                                datos += '<td class=" border border-primary inactivo text-center align-middle" ><a class="btn btn-danger" onclick="eliminar('+value.id_nivel_educativo+',\''+value.nivel_educativo+'\',\''+value.estado+'\')" data-bs-toggle="modal"  data-bs-target="#modalEliminar"><i class="fas fa-exchange-alt"></i></a></td>';
                ...
                buttons: [
                    {
                        ...
                        pageSize: 'LEGAL',
                        download: 'open',
                        title: 'SERES - Nivel Eduxativo',
                        titleAttr: 'PDF',
                        className: 'btn-danger',
                        messageTop: 'Educacion',
                        messageTop: 'PDF con la información Nivel Educativo.',
                        footer: true,
                        autoFiltre : true ,
                    ...
                    },
                    {
                        ...
                        messageTop: 'Impresión con la información de las Nivel educativo.',
                        titleAttr: 'IMPRIMIR',
                        exportOptions : {
                            stripHtml: false, /* Aquí indicamos que no se eliminen las imágenes */
                            columns: [0,1,2]
    ...
    $(document).on('click','#btnEliminar',function(event){
        event.preventDefault();
            $.ajax({
                url:'../../controlador/education.delete.php',
                type: 'POST',
                dataType: 'json',
